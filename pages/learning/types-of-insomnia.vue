<template>
  <Chapter chapter-title="Types of insomnia">
    ...
    <p>
      ...
      caused by any underlying medical issues.
    </p>
    <p>
    ...
    <p>
      ...
      <a
        href="https://www.webmd.com/sleep-disorders/insomnia-symptoms-and-causes"
        >here</a
      >. Note that if you have an account with us, then you can take
